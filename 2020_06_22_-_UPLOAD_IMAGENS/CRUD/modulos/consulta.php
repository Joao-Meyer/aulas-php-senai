    ...
    <table id="conteinerConsulta">
        ...
        <?php
            ...
            $querySelect = "select tblContatos.idContato, tblContatos.nome as nomeContato,
                            ...
                            tblEstados.sigla, tblEstados.nome as nomeEstado, tblContatos.imagem
            ...
            while ($rsContatos = mysqli_fetch_assoc($selectContatos)){
                ?>
                    <tr class="tblLinhas">
                        ...
                        <td class="tblColunas"><img src="../modulos/arquivos/<?=$rsContatos['imagem']?>" class="imagens"></td>
                        ...
                        <td class="tblColunas">
                            <div class="tblImagens">
                                ...
                                href="../modulos/delete_contato.php?modo=excluir&id=<?=$rsContatos['idContato']?>&imagem=<?=$rsContatos['imagem']?>">
